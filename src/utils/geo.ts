...
const KNOWN_PLACES: { lat: number; lng: number; label: string }[] = [
  ...
  { lat: 48.1614, lng: 11.5839, label: "München · Schwabing" },
  { lat: 48.1486, lng: 11.5708, label: "München · Maxvorstadt" },
  { lat: 48.1156, lng: 11.5444, label: "München · Sendling" },
  { lat: 48.1297, lng: 11.5969, label: "München · Haidhausen" },
  { lat: 48.1539, lng: 11.5300, label: "München · Neuhausen" },
  { lat: 49.3018, lng: 10.5723, label: "Ansbach · Innenstadt" },
  { lat: 49.3120, lng: 10.5658, label: "Ansbach · Brücken-Center" },
  { lat: 49.2990, lng: 10.5550, label: "Ansbach · Industriestraße" },
  { lat: 49.282, lng: 10.731, label: "Lichtenau (bei Ansbach)" },
  { lat: 49.343, lng: 10.791, label: "Heilsbronn" },
  { lat: 49.165, lng: 10.331, label: "Feuchtwangen" },
  { lat: 48.249, lng: 11.651, label: "Garching bei München" },
  { lat: 48.058, lng: 11.668, label: "Ottobrunn" },
  { lat: 48.260, lng: 11.434, label: "Dachau" },
